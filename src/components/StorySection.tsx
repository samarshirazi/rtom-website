  ...
  const reviews = [
    {
      ...
      quote: 'The 5-hour Smoked Lamb Shank and Brisket over Mac & Cheese are hands down the best in town. Real hickory smoke aroma that hits you as soon as you open the container!',
      rating: 5,
      date: '2 days ago',
    },
    {
      ...
      quote: 'We booked RTOM BBQ for our family gathering. The Beef Short Ribs and Leg of Lamb feast were tender enough to pull apart with a spoon. The team delivered everything steaming hot and on time!',
      rating: 5,
      date: '1 week ago',
    },
    {
      ...
      quote: 'Finally authentic halal smokehouse BBQ with real hardwood smoke. The Charcoal Whole Leg Chicken with saffron basmati rice and house garlic toum is pure comfort food.',
      rating: 5,
      date: '3 weeks ago',
    },
  ];
